...
class QuestionControllerTest {
    ...
    void 질문_등록() throws Exception {
        ...
        QuestionResponse res = new QuestionResponse(1L, 1L, QuestionCategory.TECHNICAL, "제목", "내용", 0);
    ...
    void 질문_목록() throws Exception {
        given(questionService.getList()).willReturn(List.of());
    ...
    void 질문_상세() throws Exception {
        QuestionResponse res = new QuestionResponse(1L, 1L, QuestionCategory.STUDY, "t", "c", 1);
        given(questionService.getOne(1L)).willReturn(res);
    ...
    void 질문_수정() throws Exception {
        ...
        QuestionResponse res = new QuestionResponse(1L, 1L, QuestionCategory.STUDY, "수정", "c", 0);
